...
plot(lm(satisfaction_level ~ average_montly_hours, data=HR_data))

plot.lm(lm(satisfaction_level ~ average_montly_hours, data=HR_data))
...
uczen <- structure(list(imie = "Artur", wiek = 9), class = "osobaS3")
